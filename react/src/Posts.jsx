...
export default function Posts({posts}) {
    ...
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3 justify-center mb-8">
    {posts.data?.map(post => (
    <Card key={post.id} className="m-4 w-80 2xl:w-96 col-span-1 justify-center mx-auto">
      ...
      <CardFooter className="pt-0 flex items-center justify-between">
        <Link to={`/posts/detail/${post.id}`}><Button>もっと見る</Button></Link>
        <div className="flex">
