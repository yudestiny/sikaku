...
const TopPage = ({qualifications}) => {
  ...
  <div className="justify-center bg-gray-50 py-2 pb-6 md:pb-10 lg:py-8 lg:mx-12 md:mx-4 shadow-md mb-6 lg:px-4 ">
    ...
    <div className='grid md:grid-cols-3 justify-center md:justify-around lg:justify-between md:mx-4 mx-1 gap-x-4 gap-y-6 mb-6 sm:mb-8'>
    {qualifications.slice(0,3).map((item,index) => (
      <div key={item.id} className="m-0 md:col-span-1 lg:m-2 items-center text-center max-w-lg rounded-lg">
        ...
        <Link to={"/posts"} state={{qualification:item.id}}>
          <div key={item.id} className="p-3 mx-6 md:mx-1 items-center text-center px- min-w-md max-w-lg bg-white rounded-lg shadow-xl xl:p-5 pl-10 md:pl-0 cursor-pointer">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546 5.974 5.974 0 01-2.133-1A3.75 3.75 0 0012 18z" />
              ...
              <Typography className='text-end text-xl font-bold tracking-tight text-gray-900 lg:text-2xl flex-nowrap pr-10 md:pr-0'>
                {item.name}
              </Typography>
            </div>
            <div>
  ...
  <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 md:mx-6 justify-center">
    {qualifications.slice(3).map((item,index) => (
      <div key={item.id} className="md:col-span-1 text-center justify-center items-center">
        ...
        <Link to={"/posts"} state={{qualification:item.id}}>
        <div key={item.id} className="p-2 items-center text-center max-w-lg bg-white rounded-lg shadow-md mx-8 md:mx-3 xl:mx-auto cursor-pointer">
